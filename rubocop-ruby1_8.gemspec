...
Gem::Specification.new do |spec|
  ...
  spec.version = Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/rubocop/ruby1_8/version.rb", mod) }::Rubocop::Ruby18::Version::VERSION
  ...
  spec.metadata["homepage_uri"] = "https://rubocop-ruby1-8.galtzo.com"
  ...
  # The 'git' gem is optional; rubocop-ruby1_8 falls back to shelling out to `git` if it is not present.
